...
!function(a) {
    ...
    function e(b, c) {
        ...
        e = b.className,
        f = b.value) : "string" == typeof b ? d = b : a.error("Invalid noneOption value"),
        c ? a("<option />", {
            value: f,
            "class": e,
            text: d
    ...
    function m(a, b, c) {
        ...
        "select" == c ? a.trigger("selectTime").trigger("changeTime").trigger("change", "timepicker") : -1 == ["error", "initial"].indexOf(c) && a.trigger("changeTime"),
        !0) : (a.trigger("selectTime"),
        !1)
    }
    function n(a) {
        switch (a.keyCode) {
    ...
    function o(c) {
        ...
        case 38:
            ...
            f.prev().position().top < f.outerHeight() && e.scrollTop(e.scrollTop() - f.outerHeight())) : (e.find("li").each(function(b, c) {
                return a(c).position().top > 0 ? (f = a(c),
                !1) : void 0
            }),
    ...
    function q(a) {
        ...
        return e.hasClass("ui-timepicker-disabled") ? !1 : (e.length && (d = e.data("time")),
    ...
    function r(a, b) {
        ...
        return 60 > e ? f = [e, w.mins] : (c = Math.floor(e / 60),
        d = e % 60,
